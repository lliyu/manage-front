...
export default {
	...
	methods: {
		...
		getFormData1 () {
			...
			http.get('api/sys/attr/list', params).then(function(response){
		...
		addAttr() {
			...
			http.post("api/sys/attr/add", params).then(function(res){
      ...
      let _this = this
			...
			let data =await http.post('api/sys/attr/delete', params)
		...
		async addDetail() {
			 ...
			 let data = await http.post('api/sys/attr/detail/add', params)
      ...
      let _this = this
			...
			let data =await http.post('api/sys/attr/detail/delete', params)
