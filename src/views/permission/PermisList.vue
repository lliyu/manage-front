	...
	export default {
		...
		methods: {
           ...
           name: _this.ruleForm.name,
				...
				let data = await http.post('api/permission/add', params)
          ...
          this.delPermis()
			...
			async delPermis () {
				...
				let data =await http.post('api/permission/delete', params)
			...
			async getCboData () {
				...
				let data = await http.get('api/sys/attr/detail/info', params)
          ...
          _this.message(true,data.data.msg,'error')
			...
			async getBaseCboData (val) {
				...
				let data = await http.get('api/permission/root', params)
